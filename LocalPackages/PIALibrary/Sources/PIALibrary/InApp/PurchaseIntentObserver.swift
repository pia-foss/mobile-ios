...
//
    ...
    public final class PurchaseIntentObserver: NSObject {
            ...
            if #available(iOS 16.4, *) {
                ...
                observeTask = Task { [weak self] in
                    for await purchaseIntent in PurchaseIntent.intents {
                        ...
                        self.continuation.yield(AppStoreProduct(native: purchaseIntent.product))
                    }
                }
            } else {
    ...
    extension PurchaseIntentObserver: SKPaymentTransactionObserver {
        ...
        public func paymentQueue(_ queue: SKPaymentQueue, shouldAddStorePayment payment: SKPayment, for product: SKProduct) -> Bool {
            ...
            Task { [weak self] in
                ...
                do {
                    ...
                    self.continuation.yield(AppStoreProduct(native: product))
                } catch {

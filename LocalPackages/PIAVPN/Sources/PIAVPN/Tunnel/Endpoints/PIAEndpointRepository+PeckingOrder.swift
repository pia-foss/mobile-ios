...
extension PIAEndpointRepository {
    ...
    // TEMPORARY (testing only): "DE" is not censored. It is here so the censorship pecking order
    // can be exercised on a real device from Germany. Remove before merging.

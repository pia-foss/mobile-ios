...
public enum Asset {
  ...
  public enum Piax {
    ...
    public enum Global {
      ...
      public static let iconCamera = ImageAsset(name: "PIAX/Global/icon-camera")
      public static let iconClose = ImageAsset(name: "PIAX/Global/icon-close")
  ...
  public static let iconAbout1 = ImageAsset(name: "icon-about-1")
  ...
  public static let iconAutomation = ImageAsset(name: "icon-automation")
  ...
  public static let iconNetwork = ImageAsset(name: "icon-network")
  public static let iconPrivacy1 = ImageAsset(name: "icon-privacy-1")
  public static let iconProtocols = ImageAsset(name: "icon-protocols")
  public static let iconRegion = ImageAsset(name: "icon-region")
  public static let iconRemove = ImageAsset(name: "icon-remove")
  ...
  public static let imagePurchaseSuccess1 = ImageAsset(name: "image-purchase-success 1")
  public static let imagePurchaseSuccess = ImageAsset(name: "image-purchase-success")
  public static let imageReceiptBackground = ImageAsset(name: "image-receipt-background")
  ...
  public static let imageWalkthrough1 = ImageAsset(name: "image-walkthrough-1")
  public static let imageWalkthrough2 = ImageAsset(name: "image-walkthrough-2")
  public static let imageWalkthrough3 = ImageAsset(name: "image-walkthrough-3")
  public static let itemMenu = ImageAsset(name: "item-menu")
  public static let navLogoWhite = ImageAsset(name: "nav-logo-white")
  ...
  public static let qrCode = ImageAsset(name: "qr-code")
  public static let shareIcon = ImageAsset(name: "share-icon")
}

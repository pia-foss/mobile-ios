...
public enum L10n {
  ...
  public enum Signup {
    public enum Failure {
      ...
      public static let message = L10n.tr("Signup", "failure.message", fallback: "We're unable to create an account at this time. Please try again later. Reopening the app will re-attempt to create an account.")
      /// GO BACK
      public static let submit = L10n.tr("Signup", "failure.submit", fallback: "GO BACK")
      /// Account creation failed
      public static let title = L10n.tr("Signup", "failure.title", fallback: "Account creation failed")
      /// Unknown error: %s (%d)
      ...
      /// Sign-up failed
      public static let vcTitle = L10n.tr("Signup", "failure.vc_title", fallback: "Sign-up failed")
      public enum Purchase {
        public enum Sandbox {
          /// The selected sandbox subscription is not available in production.
          public static let message = L10n.tr("Signup", "failure.purchase.sandbox.message", fallback: "The selected sandbox subscription is not available in production.")
        }
      }
      public enum Redeem {
        public enum Claimed {
          /// Looks like this card has already been claimed by another account. You can try entering a different PIN.
          public static let message = L10n.tr("Signup", "failure.redeem.claimed.message", fallback: "Looks like this card has already been claimed by another account. You can try entering a different PIN.")
          /// Card claimed already
          public static let title = L10n.tr("Signup", "failure.redeem.claimed.title", fallback: "Card claimed already")
        }
        public enum Invalid {
          /// Looks like you entered an invalid card PIN. Please try again.
          public static let message = L10n.tr("Signup", "failure.redeem.invalid.message", fallback: "Looks like you entered an invalid card PIN. Please try again.")
          /// Invalid card PIN
          public static let title = L10n.tr("Signup", "failure.redeem.invalid.title", fallback: "Invalid card PIN")
        }
      }
    }
    public enum InProgress {
      /// We're confirming your purchase with our system. It could take a moment so hang in there.
      public static let message = L10n.tr("Signup", "in_progress.message", fallback: "We're confirming your purchase with our system. It could take a moment so hang in there.")
      /// Signup.strings
      ///   PIALibrary
      /// 
      ///   Created by Davide De Rosa on 12/7/17.
      ///   Copyright © 2017 London Trust Media. All rights reserved.
      public static let title = L10n.tr("Signup", "in_progress.title", fallback: "Confirm sign-up")
      public enum Redeem {
        /// We're confirming your card PIN with our system. It could take a moment so hang in there.
        public static let message = L10n.tr("Signup", "in_progress.redeem.message", fallback: "We're confirming your card PIN with our system. It could take a moment so hang in there.")
      }
    }
    public enum Purchase {
      public enum Subscribe {
        /// Subscribe now
        public static let now = L10n.tr("Signup", "purchase.subscribe.now", fallback: "Subscribe now")
      }
      public enum Trials {
        /// Browse anonymously and hide your ip.
        public static let anonymous = L10n.tr("Signup", "purchase.trials.anonymous", fallback: "Browse anonymously and hide your ip.")
        /// Support 10 devices at once
        public static let devices = L10n.tr("Signup", "purchase.trials.devices", fallback: "Support 10 devices at once")
        /// Start your 7-day free trial
        public static let intro = L10n.tr("Signup", "purchase.trials.intro", fallback: "Start your 7-day free trial")
        /// Secure servers in 90+ countries
        public static let region = L10n.tr("Signup", "purchase.trials.region", fallback: "Secure servers in 90+ countries")
        /// More than 3300 servers in 32 countries
        public static let servers = L10n.tr("Signup", "purchase.trials.servers", fallback: "More than 3300 servers in 32 countries")
        /// Start subscription
        public static let start = L10n.tr("Signup", "purchase.trials.start", fallback: "Start subscription")
        public enum _1year {
          /// 1 year of privacy and identity protection
          public static let protection = L10n.tr("Signup", "purchase.trials.1year.protection", fallback: "1 year of privacy and identity protection")
        }
        public enum All {
          /// See all available plans
          public static let plans = L10n.tr("Signup", "purchase.trials.all.plans", fallback: "See all available plans")
        }
        public enum Devices {
          /// Protect yourself on up to 10 devices at a time.
          public static let description = L10n.tr("Signup", "purchase.trials.devices.description", fallback: "Protect yourself on up to 10 devices at a time.")
        }
        public enum Money {
          /// 30 day money back guarantee
          public static let back = L10n.tr("Signup", "purchase.trials.money.back", fallback: "30 day money back guarantee")
        }
        public enum Price {
          /// Then %@
      ...
      public enum Uncredited {
        public enum Alert {
          ...
          public static let message = L10n.tr("Signup", "purchase.uncredited.alert.message", fallback: "You have uncredited transactions. Do you want to recover your account details?")
          public enum Button {
            /// Cancel
            public static let cancel = L10n.tr("Signup", "purchase.uncredited.alert.button.cancel", fallback: "Cancel")
            /// Recover account
            public static let recover = L10n.tr("Signup", "purchase.uncredited.alert.button.recover", fallback: "Recover account")
          }
        }
      }
    }
    public enum Share {
      public enum Data {
        public enum Buttons {
          /// Accept
          public static let accept = L10n.tr("Signup", "share.data.buttons.accept", fallback: "Accept")
          /// No, thanks
          public static let noThanks = L10n.tr("Signup", "share.data.buttons.noThanks", fallback: "No, thanks")
          /// Read more
          public static let readMore = L10n.tr("Signup", "share.data.buttons.readMore", fallback: "Read more")
        }
        public enum ReadMore {
          public enum Text {
            ...
            public static let description = L10n.tr("Signup", "share.data.readMore.text.description", fallback: "This minimal information assists us in identifying and fixing potential connection issues. Note that sharing this information requires consent and manual activation as it is turned off by default.\n\nWe will collect information about the following events:\n\n    - Connection Attempt\n    - Connection Canceled\n    - Connection Established\n\nFor all of these events, we will collect the following information:\n    - Platform\n    - App version\n    - App type (pre-release or not)\n    - Protocol used\n    - Connection source (manual or using automation)\n    - Time To Connect (time between connecting and connected state)\n\nAll events will contain a unique ID, which is randomly generated. This ID is not associated with your user account. This unique ID is re-generated daily for privacy purposes.\n\nYou will always be in control. You can see what data we’ve collected from Settings, and you can turn it off at any time.")
          }
        }
        public enum Text {
          ...
          public static let description = L10n.tr("Signup", "share.data.text.description", fallback: "To help us ensure our service's connection performance, you can anonymously share your connection stats with us. These reports do not include any personally identifiable information.")
          /// You can always control this from your settings
          public static let footer = L10n.tr("Signup", "share.data.text.footer", fallback: "You can always control this from your settings")
          /// Please help us improve our service
          public static let title = L10n.tr("Signup", "share.data.text.title", fallback: "Please help us improve our service")
        }
      }
    }
    public enum Success {
      ...
      /// GET STARTED
      public static let submit = L10n.tr("Signup", "success.submit", fallback: "GET STARTED")
      /// Purchase complete
      public static let title = L10n.tr("Signup", "success.title", fallback: "Purchase complete")
      public enum Password {
        /// Password
        public static let caption = L10n.tr("Signup", "success.password.caption", fallback: "Password")
      }
      public enum Redeem {
        /// You will receive an email shortly with your username and password.
        /// 
        /// Your login details
        public static let message = L10n.tr("Signup", "success.redeem.message", fallback: "You will receive an email shortly with your username and password.\n\nYour login details")
        /// Card redeemed successfully
        public static let title = L10n.tr("Signup", "success.redeem.title", fallback: "Card redeemed successfully")
      }
      public enum Username {
        /// Username
        public static let caption = L10n.tr("Signup", "success.username.caption", fallback: "Username")
      }
    }
    public enum Unreachable {
      ...
      public static let message = L10n.tr("Signup", "unreachable.message", fallback: "No internet connection found. Please confirm that you have an internet connection and hit retry below.\n\nYou can come back to the app later to finish the process.")
      /// TRY AGAIN
      public static let submit = L10n.tr("Signup", "unreachable.submit", fallback: "TRY AGAIN")
      /// Whoops!
      public static let title = L10n.tr("Signup", "unreachable.title", fallback: "Whoops!")
      /// Error
      public static let vcTitle = L10n.tr("Signup", "unreachable.vc_title", fallback: "Error")
    }
    public enum Walkthrough {
      public enum Action {
        /// DONE
        public static let done = L10n.tr("Signup", "walkthrough.action.done", fallback: "DONE")
        /// NEXT
        public static let next = L10n.tr("Signup", "walkthrough.action.next", fallback: "NEXT")
        /// SKIP
        public static let skip = L10n.tr("Signup", "walkthrough.action.skip", fallback: "SKIP")
      }
      public enum Page {
        public enum _1 {
          /// Protect yourself on up to 10 devices at a time.
          public static let description = L10n.tr("Signup", "walkthrough.page.1.description", fallback: "Protect yourself on up to 10 devices at a time.")
          /// Support 10 devices at once
          public static let title = L10n.tr("Signup", "walkthrough.page.1.title", fallback: "Support 10 devices at once")
        }
        public enum _2 {
          /// With servers around the globe, you are always under protection.
          public static let description = L10n.tr("Signup", "walkthrough.page.2.description", fallback: "With servers around the globe, you are always under protection.")
          /// Secure servers in 90+ countries
          public static let title = L10n.tr("Signup", "walkthrough.page.2.title", fallback: "Secure servers in 90+ countries")
        }
        public enum _3 {
          /// Enabling our Content Blocker prevents ads from showing in Safari.
          public static let description = L10n.tr("Signup", "walkthrough.page.3.description", fallback: "Enabling our Content Blocker prevents ads from showing in Safari.")
          /// Protect yourself from ads
          public static let title = L10n.tr("Signup", "walkthrough.page.3.title", fallback: "Protect yourself from ads")
        }
      }
    }
  }
  public enum Welcome {
    public enum Agreement {
      ...
      public enum Message {
        /// Privacy Policy
        public static let privacy = L10n.tr("Welcome", "agreement.message.privacy", fallback: "Privacy Policy")
        /// Terms of Service
        public static let tos = L10n.tr("Welcome", "agreement.message.tos", fallback: "Terms of Service")
      }
      public enum Trials {
        ...
        public static let message = L10n.tr("Welcome", "agreement.trials.message", fallback: "Payment will be charged to your Apple ID account at the confirmation of purchase. Subscription automatically renews unless it is canceled at least 24 hours before the end of the current period. Your account will be charged for renewal within 24 hours prior to the end of the current period. You can manage and cancel your subscriptions by going to your account settings on the App Store after purchase.\n\nCertain Paid Subscriptions may offer a free trial prior to charging your payment method. If you decide to unsubscribe from a Paid Subscription before we start charging your payment method, cancel the subscription at least 24 hours before the free trial ends.\n\nFree trials are only available to new users, and are at our sole discretion, and if you attempt to sign up for an additional free trial, you will be immediately charged with the standard Subscription Fee.\n\nWe reserve the right to revoke your free trial at any time.\n\nAny unused portion of your free trial period will be forfeited upon purchase of a subscription.\n\nSigning up constitutes acceptance of this terms and conditions.")
        /// Free trials terms and conditions
        public static let title = L10n.tr("Welcome", "agreement.trials.title", fallback: "Free trials terms and conditions")
        public enum Monthly {
          /// month
          public static let plan = L10n.tr("Welcome", "agreement.trials.monthly.plan", fallback: "month")
        }
        public enum Yearly {
          /// year
          public static let plan = L10n.tr("Welcome", "agreement.trials.yearly.plan", fallback: "year")
        }
      }
    }
    public enum Gdpr {
      public enum Accept {
        public enum Button {
          /// Agree and continue
          public static let title = L10n.tr("Welcome", "gdpr.accept.button.title", fallback: "Agree and continue")
        }
      }
      public enum Collect {
        public enum Data {
          /// E-mail Address for the purposes of account management and protection from abuse.
          public static let description = L10n.tr("Welcome", "gdpr.collect.data.description", fallback: "E-mail Address for the purposes of account management and protection from abuse.")
          /// Personal information we collect
          public static let title = L10n.tr("Welcome", "gdpr.collect.data.title", fallback: "Personal information we collect")
        }
      }
      public enum Usage {
        public enum Data {
          /// E-mail address is used to send subscription information, payment confirmations, customer correspondence, and Private Internet Access promotional offers only.
          public static let description = L10n.tr("Welcome", "gdpr.usage.data.description", fallback: "E-mail address is used to send subscription information, payment confirmations, customer correspondence, and Private Internet Access promotional offers only.")
          /// Uses of personal information collected by us
          public static let title = L10n.tr("Welcome", "gdpr.usage.data.title", fallback: "Uses of personal information collected by us")
        }
      }
    }
    public enum Getstarted {
      public enum Buttons {
        /// Buy account
        public static let buyaccount = L10n.tr("Welcome", "getstarted.buttons.buyaccount", fallback: "Buy account")
      }
    }
    public enum Iap {
      public enum Error {
        /// Error
        public static let title = L10n.tr("Welcome", "iap.error.title", fallback: "Error")
        public enum Message {
          /// Apple servers currently unavailable. Please try again later.
          public static let unavailable = L10n.tr("Welcome", "iap.error.message.unavailable", fallback: "Apple servers currently unavailable. Please try again later.")
        }
      }
    }
    public enum Login {
      /// LOGIN
      public static let submit = L10n.tr("Welcome", "login.submit", fallback: "LOGIN")
      /// Welcome.strings
      ///   PIALibrary
      /// 
      ///   Created by Davide De Rosa on 12/7/17.
      ///   Copyright © 2017 London Trust Media. All rights reserved.
      public static let title = L10n.tr("Welcome", "login.title", fallback: "Sign in to your account")
      public enum Error {
        ...
        /// Log in
        public static let title = L10n.tr("Welcome", "login.error.title", fallback: "Log in")
        /// Your username or password is incorrect.
        public static let unauthorized = L10n.tr("Welcome", "login.error.unauthorized", fallback: "Your username or password is incorrect.")
        /// You must enter a username and password.
        public static let validation = L10n.tr("Welcome", "login.error.validation", fallback: "You must enter a username and password.")
      }
      public enum Magic {
        public enum Link {
          /// Please check your e-mail for a login link.
          public static let response = L10n.tr("Welcome", "login.magic.link.response", fallback: "Please check your e-mail for a login link.")
          /// Send Link
          public static let send = L10n.tr("Welcome", "login.magic.link.send", fallback: "Send Link")
          /// Login using magic email link
          public static let title = L10n.tr("Welcome", "login.magic.link.title", fallback: "Login using magic email link")
          public enum Invalid {
            /// Invalid email. Please try again.
            public static let email = L10n.tr("Welcome", "login.magic.link.invalid.email", fallback: "Invalid email. Please try again.")
          }
        }
      }
      public enum Password {
        /// Password
        public static let placeholder = L10n.tr("Welcome", "login.password.placeholder", fallback: "Password")
      }
      public enum Receipt {
        /// Login using purchase receipt
        public static let button = L10n.tr("Welcome", "login.receipt.button", fallback: "Login using purchase receipt")
      }
      public enum Restore {
        /// Didn't receive account details?
        public static let button = L10n.tr("Welcome", "login.restore.button", fallback: "Didn't receive account details?")
      }
      public enum Username {
        /// Username (p1234567)
        public static let placeholder = L10n.tr("Welcome", "login.username.placeholder", fallback: "Username (p1234567)")
      }
    }
    public enum Plan {
      /// Best value
      public static let bestValue = L10n.tr("Welcome", "plan.best_value", fallback: "Best value")
      /// %@/mo
      ...
      public enum Accessibility {
        /// per month
        public static let perMonth = L10n.tr("Welcome", "plan.accessibility.per_month", fallback: "per month")
      }
      public enum Monthly {
        /// Monthly
        public static let title = L10n.tr("Welcome", "plan.monthly.title", fallback: "Monthly")
      }
      public enum Yearly {
        /// %@%@ per year
        ...
        /// Yearly
        public static let title = L10n.tr("Welcome", "plan.yearly.title", fallback: "Yearly")
      }
    }
    public enum Purchase {
      /// Continue
      public static let `continue` = L10n.tr("Welcome", "purchase.continue", fallback: "Continue")
      /// or
      public static let or = L10n.tr("Welcome", "purchase.or", fallback: "or")
      /// Submit
      public static let submit = L10n.tr("Welcome", "purchase.submit", fallback: "Submit")
      /// 30-day money back guarantee
      public static let subtitle = L10n.tr("Welcome", "purchase.subtitle", fallback: "30-day money back guarantee")
      /// Select a VPN plan
      public static let title = L10n.tr("Welcome", "purchase.title", fallback: "Select a VPN plan")
      public enum Confirm {
        ...
        public enum Form {
          /// Enter your email address
          public static let email = L10n.tr("Welcome", "purchase.confirm.form.email", fallback: "Enter your email address")
        }
      }
      public enum Email {
        /// Email address
        public static let placeholder = L10n.tr("Welcome", "purchase.email.placeholder", fallback: "Email address")
        /// We need your email to send your username and password.
        public static let why = L10n.tr("Welcome", "purchase.email.why", fallback: "We need your email to send your username and password.")
      }
      public enum Error {
        /// Purchase
        public static let title = L10n.tr("Welcome", "purchase.error.title", fallback: "Purchase")
        /// You must enter an email address.
        public static let validation = L10n.tr("Welcome", "purchase.error.validation", fallback: "You must enter an email address.")
        public enum Connectivity {
          ...
          public static let description = L10n.tr("Welcome", "purchase.error.connectivity.description", fallback: "We are unable to reach Private Internet Access. This may due to poor internet or our service is blocked in your country.")
          /// Connection Failure
          public static let title = L10n.tr("Welcome", "purchase.error.connectivity.title", fallback: "Connection Failure")
        }
      }
      public enum Login {
        /// Sign in
        public static let button = L10n.tr("Welcome", "purchase.login.button", fallback: "Sign in")
        /// Already have an account?
        public static let footer = L10n.tr("Welcome", "purchase.login.footer", fallback: "Already have an account?")
      }
    }
    public enum Redeem {
      /// SUBMIT
      public static let submit = L10n.tr("Welcome", "redeem.submit", fallback: "SUBMIT")
      ...
      /// Redeem gift card
      public static let title = L10n.tr("Welcome", "redeem.title", fallback: "Redeem gift card")
      public enum Accessibility {
        /// Back
        public static let back = L10n.tr("Welcome", "redeem.accessibility.back", fallback: "Back")
      }
      public enum Email {
        /// Email address
        public static let placeholder = L10n.tr("Welcome", "redeem.email.placeholder", fallback: "Email address")
      }
      public enum Error {
        /// Please type in your email and card PIN.
        public static let allfields = L10n.tr("Welcome", "redeem.error.allfields", fallback: "Please type in your email and card PIN.")
        ...
        /// Redeem
        public static let title = L10n.tr("Welcome", "redeem.error.title", fallback: "Redeem")
      }
      public enum Giftcard {
        /// Gift card PIN
        public static let placeholder = L10n.tr("Welcome", "redeem.giftcard.placeholder", fallback: "Gift card PIN")
      }
    }
    public enum Restore {
      /// CONFIRM
      public static let submit = L10n.tr("Welcome", "restore.submit", fallback: "CONFIRM")
      ...
      public static let subtitle = L10n.tr("Welcome", "restore.subtitle", fallback: "If you purchased a plan through this app and didn't receive your credentials, you can send them again from here. You will not be charged during this process.")
      /// Restore uncredited purchase
      public static let title = L10n.tr("Welcome", "restore.title", fallback: "Restore uncredited purchase")
      public enum Email {
        /// Email address
        public static let placeholder = L10n.tr("Welcome", "restore.email.placeholder", fallback: "Email address")
      }
    }
    public enum Update {
      public enum Account {
        public enum Email {
          ...
          public static let error = L10n.tr("Welcome", "update.account.email.error", fallback: "Failed to modify account email")
        }
      }
    }
    public enum Upgrade {
      /// Welcome Back!
      public static let header = L10n.tr("Welcome", "upgrade.header", fallback: "Welcome Back!")
      /// In order to use Private Internet Access, you’ll need to renew your subscription.
      public static let title = L10n.tr("Welcome", "upgrade.title", fallback: "In order to use Private Internet Access, you’ll need to renew your subscription.")
      public enum Renew {
        /// Renew now
        public static let now = L10n.tr("Welcome", "upgrade.renew.now", fallback: "Renew now")
      }
    }
  }
}

...
enum Asset {
  enum Images {
    ...
    static let iconThumbsDown = ImageAsset(name: "icon-thumbs-down")
    static let iconThumbsUp = ImageAsset(name: "icon-thumbs-up")
    ...
    static let imageAccessCard = ImageAsset(name: "image-access-card")
  ...
  enum Ui {
    enum Piax {
      enum Global {
        static let centeredDarkMap = ImageAsset(name: "centered-dark-map")
        static let centeredLightMap = ImageAsset(name: "centered-light-map")
        static let computerIcon = ImageAsset(name: "computer-icon")
        static let globeIcon = ImageAsset(name: "globe-icon")
        static let iconBack = ImageAsset(name: "icon-back")
        static let iconCamera = ImageAsset(name: "icon-camera")
        static let iconClose = ImageAsset(name: "icon-close")
        static let iconWarning = ImageAsset(name: "icon-warning")
        ...
        static let planSelected = ImageAsset(name: "plan-selected")
        static let planUnselected = ImageAsset(name: "plan-unselected")
        ...
        static let shieldIcon = ImageAsset(name: "shield-icon")
      }
    }
    static let closeIcon = ImageAsset(name: "close-icon")
    static let imageAccountFailed = ImageAsset(name: "image-account-failed")
    static let imageDocumentConsent = ImageAsset(name: "image-document-consent")
    ...
    static let allImages: [ImageAsset] = [
      Piax.Global.centeredDarkMap,
      Piax.Global.centeredLightMap,
      Piax.Global.computerIcon,
      Piax.Global.globeIcon,
      Piax.Global.iconBack,
      Piax.Global.iconCamera,
      Piax.Global.iconClose,
      Piax.Global.iconWarning,
      Piax.Global.pagecontrolSelectedDot,
      Piax.Global.pagecontrolUnselectedDot,
      Piax.Global.planSelected,
      Piax.Global.planUnselected,
      Piax.Global.scrollableMapDark,
      Piax.Global.scrollableMapLight,
      Piax.Global.shieldIcon,
      closeIcon,
      imageAccountFailed,
      imageDocumentConsent,
      imageNoInternet,
      imagePurchaseSuccess,

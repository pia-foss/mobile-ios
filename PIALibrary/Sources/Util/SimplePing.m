...
- (void)sendPingWithData:(NSData *)data {
    ...
    __block NSData *                packet;
    __block ssize_t                 bytesSent;
    __block id<SimplePingDelegate>  strongDelegate;
    
    dispatch_queue_t backgroundQueue = dispatch_queue_create("com.elbsolutions.simpleping", NULL);
